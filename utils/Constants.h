...
// SHOOTER A 
static const int LAUNCHER_A_A_FORWARD_CHAN = 1024;
static const int LAUNCHER_A_B_FORWARD_CHAN = 1024;
static const int LAUNCHER_A_A_REVERSE_CHAN = 1024;
static const int LAUNCHER_A_B_REVERSE_CHAN = 1024;
static const int LAUNCHER_A_TRIGGER_FORWARD_CHAN = 1024;
static const int LAUNCHER_A_TRIGGER_REVERSE_CHAN = 1024;

// ROBOT B
static const int SHOOTER_B_MOTOR = 1024;
// SHOOTER B (WILLMAN'S SHOOTER)
static const int LAUNCHER_B_TRIGGER_FORWARD_CHAN = 1024;
static const int LAUNCHER_B_TRIGGER_REVERSE_CHAN = 1024;
